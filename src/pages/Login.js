...
const Login = () => {
  return (
    ...
    <div>
        ...
        <Button title="login" className="w-full font-semibold text-white text-lg uppercase py-3 rounded-[20px] bg-primary"/>
    </div>
    <div className='text-center my-8'>
        <h3 className='font-regular text-bl text-lg'>Don't have an account?  <span className='text-primary'> sign up</span></h3>
